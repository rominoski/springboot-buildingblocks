...
@Schema(description="This model is to create an user")
//Entity 
@Entity
@Table(name="userss")
...
public class User extends RepresentationModel{
	@Schema(description= "Autogenerated unique id", required = true)
	@Id
	@GeneratedValue
	@JsonView(Views.External.class)
	private Long userid;
	@Schema(description= "User name should be flname", example="dlira", required=false)
